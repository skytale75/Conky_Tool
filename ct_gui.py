...
class Notebook:
    ...
    def create_widgets(self, title):
        ...
        nb.color_button = tk.Button(nb.frame, text="Colors", command=lambda: add_color_window(nb.file_display, nb.custom_window))
        ...
        nb.themes_button = tk.Button(nb.frame, text='Themes', command=lambda: themes_window(nb.file_display, nb.custom_window))
